...
- To enable "Core" or any of the two DLCs, download this file or extract the contents from your "Extras" folder inside the server files: https://github.com/TastyLollipop/OpenWorld/raw/main/Core%20%26%20DLCs.zip
