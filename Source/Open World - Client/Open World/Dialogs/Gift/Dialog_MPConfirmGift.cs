...
namespace OpenWorld
{
    public class Dialog_MPConfirmGift : Window
    {
        public override Vector2 InitialSize => new Vector2(350f, 150f);

        private string windowTitle = "Warning!";
        private string windowDescription = "Are you sure you want to gift these items?";

        private float buttonX = 137f;
        private float buttonY = 38f;

        public Dialog_MPConfirmGift()
        {
        ...
        public override void DoWindowContents(Rect rect)
        {
            ...
            {
                MPCaravan.TakeItemsFromCaravan(0);

                GiftHandler.SendGiftsToSettlement();
