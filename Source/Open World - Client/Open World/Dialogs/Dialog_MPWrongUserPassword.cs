...
namespace OpenWorld
{
    public class Dialog_MPWrongUserPassword : Window
    {
        public override Vector2 InitialSize => new Vector2(400f, 150f);

        private string windowTitle = "Error!";
        private string windowDescription = "Username is already in use or password is incorrect.";

        private float buttonX = 150f;
        private float buttonY = 38f;

        public Dialog_MPWrongUserPassword()
        {
