...
namespace OpenWorld
{
    public class Dialog_MPDisconnected : Window
    {
        public override Vector2 InitialSize => new Vector2(350f, 150f);

        private string windowTitle = "Error!";
        private string windowDescription = "You have been disconnected from the server";

        private float buttonX = 150f;
        private float buttonY = 38f;

        public Dialog_MPDisconnected()
        {
            Main._ParametersCache.__MPDisconnected = this;
