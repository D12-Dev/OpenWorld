...
namespace OpenWorld
{
    public class Dialog_MPFactionRecruit : Window
    {
        public override Vector2 InitialSize => new Vector2(350f, 150f);

        private string windowTitle = "Warning!";
        private string windowDescription = "Are you sure you want to recruit this player?";
        ...
        public Dialog_MPFactionRecruit(Dialog_MPFactionOnPlayer factionMenu)
        {
        ...
        public override void DoWindowContents(Rect rect)
        {
            ...
            {
                Networking.SendData("FactionManagement│AddMember│" + Main._ParametersCache.focusedSettlement.Tile);
                factionMenu.Close();
                Close();
            }
