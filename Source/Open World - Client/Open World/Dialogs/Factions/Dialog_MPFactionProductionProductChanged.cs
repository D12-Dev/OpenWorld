...
namespace OpenWorld
{
    public class Dialog_MPFactionProductionProductChanged : Window
    {
        public override Vector2 InitialSize => new Vector2(350f, 150f);

        private string windowTitle = "Info";
        private string windowDescription = "Your production product has been changed";

        private float buttonX = 150f;
        private float buttonY = 38f;

        public Dialog_MPFactionProductionProductChanged()
        {
