...
namespace OpenWorld
{
    public class Dialog_MPFactionAlreadyInFaction : Window
    {
        public override Vector2 InitialSize => new Vector2(350f, 150f);

        private string windowTitle = "Error!";
        private string windowDescription = "That player is already in a faction";

        private float buttonX = 150f;
        private float buttonY = 38f;

        public Dialog_MPFactionAlreadyInFaction()
        {
