...
namespace OpenWorld
{
    public class Dialog_MPFactionKick : Window
    {
        ...
        public Dialog_MPFactionKick(Dialog_MPFactionOnPlayer factionMenu)
        {
        ...
        public override void DoWindowContents(Rect rect)
        {
            ...
            {
                Networking.SendData("FactionManagement│RemoveMember│" + Main._ParametersCache.focusedSettlement.Tile);
                factionMenu.Close();
                Close();
            }
