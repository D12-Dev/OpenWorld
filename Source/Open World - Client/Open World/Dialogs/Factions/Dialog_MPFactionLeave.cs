...
namespace OpenWorld
{
    public class Dialog_MPFactionLeave : Window
    {
        public override Vector2 InitialSize => new Vector2(350f, 150f);

        private string windowTitle = "Warning!";
        private string windowDescription = "Are you sure you want to leave the faction?";
        ...
        public Dialog_MPFactionLeave(Dialog_MPFactionMenu factionMenu)
        {
        ...
        public override void DoWindowContents(Rect rect)
        {
            ...
            {
                Networking.SendData("FactionManagement│Leave");
                factionMenu.Close();
                Close();
            }
