...
namespace OpenWorld
{
    public class Dialog_MPFactionSiteDemolish : Window
    {
        ...
        public Dialog_MPFactionSiteDemolish()
        {
        ...
        public override void DoWindowContents(Rect rect)
        {
            ...
            {
                Networking.SendData("FactionManagement│DestroyStructure│" + Main._ParametersCache.focusedTile);
                Close();
            }
