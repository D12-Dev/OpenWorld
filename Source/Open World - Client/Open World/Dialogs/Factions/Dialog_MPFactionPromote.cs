...
namespace OpenWorld
{
    public class Dialog_MPFactionPromote : Window
    {
        public override Vector2 InitialSize => new Vector2(350f, 150f);

        private string windowTitle = "Warning!";
        private string windowDescription = "Are you sure you want to promote this player?";

        private float buttonX = 137f;
        private float buttonY = 38f;

        Dialog_MPFactionOnPlayer factionMenu;

        public Dialog_MPFactionPromote(Dialog_MPFactionOnPlayer factionMenu)
        {
        ...
        public override void DoWindowContents(Rect rect)
        {
            ...
            {
                Networking.SendData("FactionManagement│PromoteMember│" + Main._ParametersCache.focusedSettlement.Tile);
                factionMenu.Close();
                Close();
            }
